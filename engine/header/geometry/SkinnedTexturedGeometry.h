...
#define SKINNEDTEXTUREDGEOMETRY_ALBEDOTEXTURE_CONFIGFILE_NAME_FIELD L"albedoTexture_inputConfigFileName"
#define SKINNEDTEXTUREDGEOMETRY_ALBEDOTEXTURE_CONFIGFILE_PATH_FIELD L"albedoTexture_inputConfigFilePath"
